...
export default class MyCourses extends React.Component {
    constructor() {
        ...
        if (result3 == null || result3 == undefined) {
            if ((result4 == null || result4 == undefined)) {
                ...
                if (a == 2) {
                    iemail = result4.email; ///email
                    this.uidemail = iemail;
                    let notify='yes';
                    try {
                        axios.get('http://localhost:5000/courseinstructor/' + iemail+ "/" + notify).then(response => {
                    ...
                    try {
                        axios.get('http://localhost:5000/courseinstructor/' + iemail+ "/" + 'no').then(response => {
                    ...
                    let enrolled='yes';
                    try {
                        axios.get('http://localhost:5000/studentenroll/' + semail+ "/" + enrolled).then(response => {
    ...
    handleClick2(e) {
        ...
        try {
            axios.post('http://localhost:5000/course/update/' +courseid,up).then(
        ...
        try {
            axios.post('http://localhost:5000/courseinstructor/update/' +courseid+ "/" + result5.email,up2).then(
